...
export function HeroSection() {
    ...
    const renderDeviceComponent = () => {
        if (!isClient) {
            ...
            return <div className="w-full aspect-[433/882] bg-card rounded-xl animate-pulse drop-shadow-2xl" />;
        }
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
                <div className="space-y-6 md:space-y-8 text-center lg:text-left">
                    <div className="space-y-4">
                        ...
                        <p className="text-lg sm:text-xl lg:text-2xl text-foreground leading-relaxed max-w-2xl mx-auto lg:mx-0">
