                ...
                <Card className="bg-white/90 backdrop-blur-sm border-[#565264]/10">
                    <CardHeader>
                        <CardTitle className="text-3xl font-bold text-center">
                            <span className="text-[#565264]">Privacy Policy</span>
                        </CardTitle>
                    ...
                    <CardContent className="prose prose-slate max-w-none space-y-6">
                        <section>
                            <h2 className="text-xl font-semibold text-[#565264] mb-3">1. Information We Collect</h2>
                            ...
                            <h3 className="text-lg font-medium text-[#565264] mb-2">Personal Information</h3>
                        ...
                        <section>
                            <h2 className="text-xl font-semibold text-[#565264] mb-3">2. How We Use Your Information</h2>
                            <p className="text-[#565264]/80 leading-relaxed mb-3">
                        ...
                        <section>
                            <h2 className="text-xl font-semibold text-[#565264] mb-3">3. Information Sharing</h2>
                            ...
                            <ul className="list-disc list-inside text-[#565264]/80 space-y-1 ml-4 mt-3">
                        ...
                        <section>
                            <h2 className="text-xl font-semibold text-[#565264] mb-3">4. Data Security</h2>
                            <p className="text-[#565264]/80 leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl font-semibold text-[#565264] mb-3">5. Data Retention</h2>
                            <p className="text-[#565264]/80 leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl font-semibold text-[#565264] mb-3">6. Your Rights</h2>
                            <p className="text-[#565264]/80 leading-relaxed mb-3">
                        ...
                        <section>
                            <h2 className="text-xl font-semibold text-[#565264] mb-3">7. Cookies and Tracking</h2>
                            <p className="text-[#565264]/80 leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl font-semibold text-[#565264] mb-3">8. Third-Party Services</h2>
                            <p className="text-[#565264]/80 leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl font-semibold text-[#565264] mb-3">9. Changes to This Policy</h2>
                            <p className="text-[#565264]/80 leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl font-semibold text-[#565264] mb-3">10. Contact Us</h2>
                            <p className="text-[#565264]/80 leading-relaxed">
